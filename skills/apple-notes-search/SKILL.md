...
description: Search, recall, and discover connections across the user's own Apple Notes via the apple-notes MCP server — semantic + keyword search, Swanson-ABC bridges, entity threads, related-notes, and cited synthesis over everything they've ever written. Use AGGRESSIVELY whenever the user wants to find, recall, look up, or "remember" something from their notes ("search my notes for X", "what did I write about X", "find that note about X", "did I ever note Y"), surface non-obvious connections ("find connections/bridges across my notes", "what links X and Y in my notes", "show related notes"), or synthesize a position ("synthesize/summarize what I think about X from my notes", "pull together everything I've written on X"). Also triggers on "index my Apple Notes", note tags/folders queries, and "what's connected to" questions over personal notes. Do NOT use for creating reminders or for non-Apple-Notes note systems.
---
